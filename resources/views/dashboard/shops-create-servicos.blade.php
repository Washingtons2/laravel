                    ...
                    <div class="card-body">
                      ...
                      <p class="card-text">
                        ...
                        <div class="alert alert-secondary" role="alert">
                            Loja do tipo <a href="#" class="alert-link">serviços</a>.
                        </div>
                        <!-- formulário -->
                        <form class="mt-2">
                            <div class="form-group">
                                <label for="exampleFormControlInput1">Fotos do serviço</label>

                                <img src="{{ asset("img/no-product-image.svg") }}" class="img-thumbnail d-block mb-3" alt="...">

                                <input type="file" class="form-control-file" id="exampleFormControlFile1">
                                <small id="emailHelp" class="form-text text-muted">A primeira foto será considerada foto principal da exibição do serviço.</small>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="exampleFormControlInput1">Descrição do serviço</label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <select class="custom-select" id="inputGroupSelect03" aria-label="Example select with button addon">
                                      <option selected>Categoria do serviço</option>
                            ...
                            <div class="form-group">
                                ...
                                <button class="btn btn-outline-secondary btn-block mt-2 mb-3">Criar nova variação</button>

                                <div class="list-group mb-3">
                                    <div class="list-group-item">
                                        <div class="d-flex w-100 justify-content-between">
                                            <h5 class="mb-1">Sombrancelhas + Busto</h5>
                                        </div>
                                        <p class="mb-1">Descrição do serviço para ser melhor descrito.</p>
                                        <small>R$: 33,90</small>
                                    </div>
                                </div>
                                <div class="list-group mb-3">
