...
<form class="mt-5">
                    <div class="form-group">
                        <input type="email" class="form-control" placeholder="Entrar com Email" id="exampleInputEmail1" aria-describedby="emailHelp">
                    ...
                    <button type="submit" class="btn btn-violet btn-lg btn-block rounded-lg">Entrar</button>
</form>
</div>
